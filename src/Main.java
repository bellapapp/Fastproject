public class Main {
    ...
    public static void printTema2() {
        System.out.println(20 + 7);
    }

    public static void printTema3() {
        System.out.println((float) 55 / 9);
    }

    public static void printTema4a() {
        System.out.println(-5 + 8 * 6);
    }

    public static void printTema4b() {
        System.out.println((55 + 9) % 9);
    }

    public static void printTema4c() {
        System.out.println(20 + -3 * 5 / 8);
    }

    public static void printTema4d() {
        System.out.println(5 + 15 / 3 * 2 - 8 % 3);
    }
}
